...
__global__ void cuda_copy_real_part_to_q_double_complex_kernel(muDoubleComplex *q, const double *q_real, const int matrixRows, const int l_rows, const int l_cols_nev) {
...
extern "C" void musa_copy_real_part_to_q_double_complex_FromC(double _Complex *q_dev, double *q_real_dev, int *matrixRows_in, int *l_rows_in, int *l_cols_nev_in, musaStream_t  my_stream){
  int l_rows = *l_rows_in;
  int l_cols_nev = *l_cols_nev_in;
  int matrixRows = *matrixRows_in;

  muDoubleComplex* q_casted = (muDoubleComplex*) q_dev;
...
__global__ void cuda_copy_real_part_to_q_float_complex_kernel(muFloatComplex *q, const float *q_real, const int matrixRows, const int l_rows, const int l_cols_nev) {
    int row = blockIdx.x * blockDim.x + threadIdx.x;
    int col = blockIdx.y * blockDim.y + threadIdx.y;
...
extern "C" void musa_copy_real_part_to_q_float_complex_FromC(float _Complex *q_dev, float *q_real_dev, int *matrixRows_in, int *l_rows_in, int *l_cols_nev_in, musaStream_t  my_stream){
  int l_rows = *l_rows_in;
  int l_cols_nev = *l_cols_nev_in;
  int matrixRows = *matrixRows_in;

  muFloatComplex* q_casted = (muFloatComplex*) q_dev;
...
extern "C" void musa_zero_skewsymmetric_q_double_FromC(double *q_dev, int *matrixRows_in, int *matrixCols_in, musaStream_t  my_stream){
...
extern "C" void musa_zero_skewsymmetric_q_float_FromC(float *q_dev, int *matrixRows_in, int *matrixCols_in, musaStream_t  my_stream){
  int matrixCols = *matrixCols_in;
  int matrixRows = *matrixRows_in;
...
extern "C" void musa_copy_skewsymmetric_second_half_q_double_FromC(double *q_dev, int *i_in, int *matrixRows_in, int *matrixCols_in, int *negative_or_positive_in, musaStream_t  my_stream){
  int matrixCols = *matrixCols_in;
  int matrixRows = *matrixRows_in;
...
extern "C" void musa_copy_skewsymmetric_second_half_q_float_FromC(float *q_dev, int *i_in, int *matrixRows_in, int *matrixCols_in, int *negative_or_positive_in, musaStream_t  my_stream){
  int matrixCols = *matrixCols_in;
  int matrixRows = *matrixRows_in;
  int negative_or_positive = *negative_or_positive_in;
  int i = *i_in;
...
extern "C" void musa_copy_skewsymmetric_first_half_q_double_FromC(double *q_dev, int *i_in, int *matrixRows_in, int *matrixCols_in, int *negative_or_positive_in, musaStream_t  my_stream){
  int matrixRows = *matrixRows_in;
  int matrixCols = *matrixCols_in;
  int negative_or_positive = *negative_or_positive_in;
  int i = *i_in;
...
extern "C" void musa_copy_skewsymmetric_first_half_q_float_FromC(float *q_dev, int *i_in, int *matrixRows_in, int *matrixCols_in, int *negative_or_positive_in, musaStream_t  my_stream){
  int matrixRows = *matrixRows_in;
  int matrixCols = *matrixCols_in;
  int negative_or_positive = *negative_or_positive_in;
  int i = *i_in;
...
extern "C" void musa_get_skewsymmetric_second_half_q_double_FromC(double *q_dev, double *q_2_dev, int *matrixRows_in, int *matrixCols_in, musaStream_t  my_stream){
  int matrixRows = *matrixRows_in;
  int matrixCols = *matrixCols_in;
...
extern "C" void musa_get_skewsymmetric_second_half_q_float_FromC(float *q_dev, float *q_2_dev, int *matrixRows_in, int *matrixCols_in, musaStream_t  my_stream){
  int matrixRows = *matrixRows_in;
  int matrixCols = *matrixCols_in;
...
extern "C" void musa_put_skewsymmetric_second_half_q_double_FromC(double *q_dev, double *q2_dev, int *matrixRows_in, int *matrixCols_in, musaStream_t  my_stream){
  int matrixRows = *matrixRows_in;
  int matrixCols = *matrixCols_in;
...
extern "C" void musa_put_skewsymmetric_second_half_q_float_FromC(float *q_dev, float *q2_dev, int *matrixRows_in, int *matrixCols_in, musaStream_t  my_stream){
  int matrixRows = *matrixRows_in;
  int matrixCols = *matrixCols_in;
