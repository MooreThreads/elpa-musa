...
__global__ void my_pack_c_cuda_kernel_complex_double(const int n_offset, const int max_idx, const int stripe_width, const int a_dim2, const int l_nev, muDoubleComplex *src, muDoubleComplex *dst, int i_off)
#else
__global__ void my_pack_c_cuda_kernel_complex_single(const int n_offset, const int max_idx, const int stripe_width, const int a_dim2, const int l_nev, muFloatComplex *src, muFloatComplex *dst, int i_off)
#endif
#endif
{
    int b_id = blockIdx.y;
...
#if COMPLEXCASE == 1
#ifdef DOUBLE_PRECISION_COMPLEX
__global__ void my_unpack_c_cuda_kernel_complex_double(const int n_offset, const int max_idx, const int stripe_width, const int a_dim2, const int l_nev, muDoubleComplex *src, muDoubleComplex *dst, int i_off)
#else
__global__ void my_unpack_c_cuda_kernel_complex_single(const int n_offset, const int max_idx, const int stripe_width, const int a_dim2, const int l_nev, muFloatComplex *src, muFloatComplex *dst, int i_off)
#endif
#endif
{
    int b_id = blockIdx.y;
...
#if COMPLEXCASE == 1
#ifdef DOUBLE_PRECISION_COMPLEX
__global__ void extract_hh_tau_c_cuda_kernel_complex_double(muDoubleComplex *hh, muDoubleComplex *hh_tau, const int nbw, const int n, int val)
#else
__global__ void extract_hh_tau_c_cuda_kernel_complex_single(muFloatComplex *hh, muFloatComplex *hh_tau, const int nbw, const int n, int val)
#endif
#endif
{
...
#if REALCASE == 1
#ifdef DOUBLE_PRECISION_REAL
extern "C" void launch_my_pack_c_cuda_kernel_real_double(const int row_count, const int n_offset, const int max_idx, const int stripe_width, const int a_dim2, const int stripe_count, const int l_nev, double *a_dev, double *row_group_dev, musaStream_t my_stream)
#else
extern "C" void launch_my_pack_c_cuda_kernel_real_single(const int row_count, const int n_offset, const int max_idx, const int stripe_width, const int a_dim2, const int stripe_count, const int l_nev, float *a_dev, float *row_group_dev, musaStream_t my_stream)
#endif
#endif
#if COMPLEXCASE == 1
#ifdef DOUBLE_PRECISION_COMPLEX
extern "C" void launch_my_pack_c_cuda_kernel_complex_double(const int row_count, const int n_offset, const int max_idx, const int stripe_width, const int a_dim2, const int stripe_count, const int l_nev, muDoubleComplex *a_dev, muDoubleComplex *row_group_dev, musaStream_t my_stream)
#else
extern "C" void launch_my_pack_c_cuda_kernel_complex_single(const int row_count, const int n_offset, const int max_idx, const int stripe_width, const int a_dim2, const int stripe_count, const int l_nev, muFloatComplex *a_dev, muFloatComplex *row_group_dev, musaStream_t my_stream)
#endif
#endif
{
...
#if REALCASE == 1
#ifdef DOUBLE_PRECISION_REAL
extern "C" void launch_extract_hh_tau_c_cuda_kernel_real_double(double *bcast_buffer_dev, double *hh_tau_dev, const int nbw, const int n, const int is_zero, musaStream_t my_stream)
#else
extern "C" void launch_extract_hh_tau_c_cuda_kernel_real_single(float *bcast_buffer_dev, float *hh_tau_dev, const int nbw, const int n, const int is_zero, musaStream_t my_stream)
#endif
#endif
#if COMPLEXCASE == 1
#ifdef DOUBLE_PRECISION_COMPLEX
extern "C" void launch_extract_hh_tau_c_cuda_kernel_complex_double(muDoubleComplex *bcast_buffer_dev, muDoubleComplex *hh_tau_dev, const int nbw, const int n, const int is_zero, musaStream_t my_stream)
#else
extern "C" void launch_extract_hh_tau_c_cuda_kernel_complex_single(muFloatComplex *bcast_buffer_dev, muFloatComplex *hh_tau_dev, const int nbw, const int n, const int is_zero, musaStream_t my_stream)
#endif
#endif
{
    musaError_t err;
...
#if REALCASE == 1
#ifdef DOUBLE_PRECISION_REAL
extern "C" void launch_my_unpack_c_cuda_kernel_real_double(const int row_count, const int n_offset, const int max_idx, const int stripe_width, const int a_dim2, const int stripe_count, const int l_nev, double *row_group_dev, double *a_dev, musaStream_t my_stream)
#else
extern "C" void launch_my_unpack_c_cuda_kernel_real_single(const int row_count, const int n_offset, const int max_idx, const int stripe_width, const int a_dim2, const int stripe_count, const int l_nev, float *row_group_dev, float *a_dev, musaStream_t my_stream)
#endif
#endif
#if COMPLEXCASE == 1
#ifdef DOUBLE_PRECISION_COMPLEX
extern "C" void launch_my_unpack_c_cuda_kernel_complex_double(const int row_count, const int n_offset, const int max_idx, const int stripe_width, const int a_dim2, const int stripe_count, const int l_nev, muDoubleComplex *row_group_dev, muDoubleComplex *a_dev, musaStream_t my_stream)
#else
extern "C" void launch_my_unpack_c_cuda_kernel_complex_single(const int row_count, const int n_offset, const int max_idx, const int stripe_width, const int a_dim2, const int stripe_count, const int l_nev, muFloatComplex *row_group_dev, muFloatComplex *a_dev, musaStream_t my_stream)
#endif
#endif
{
    if (stripe_width <= 0) return;
...
extern "C" int musa_MemcpyDeviceToDevice(int val)
{
    val = musaMemcpyDeviceToDevice;
    return val;
}
