...
! This file is the generated version. Do NOT edit
  ...
  interface
    function cuda_device_get_attributes_c(value, attribute) result(istat) &
             bind(C, name="musaDeviceGetAttributeFromC")
  ...
  interface
    function cuda_device_get_capability_c(value) result(istat) &
             bind(C, name="musaDeviceGetCapabilityFromC")
      use, intrinsic :: iso_c_binding
      implicit none
  ...
  interface
    function cublas_get_version_c(cublasHandle, version) result(istat) &
             bind(C, name="mublasGetVersionFromC")
      use, intrinsic :: iso_c_binding
      implicit none
  ...
  interface
    function cuda_get_last_error_c() result(istat) &
             bind(C, name="musaGetLastErrorFromC")
      use, intrinsic :: iso_c_binding
      implicit none
      integer(kind=c_int)              :: istat
    end function
  ...
  interface
    function cuda_stream_create_c(cudaStream) result(istat) &
             bind(C, name="musaStreamCreateFromC")
      use, intrinsic :: iso_c_binding
      implicit none
  ...
  interface
    function cuda_stream_destroy_c(cudaStream) result(istat) &
             bind(C, name="musaStreamDestroyFromC")
      use, intrinsic :: iso_c_binding
      implicit none
  ...
  interface
    function cuda_stream_synchronize_explicit_c(cudaStream) result(istat) &
             bind(C, name="musaStreamSynchronizeExplicitFromC")
      use, intrinsic :: iso_c_binding
      implicit none
  ...
  interface
    function cuda_stream_synchronize_implicit_c() result(istat) &
             bind(C, name="musaStreamSynchronizeImplicitFromC")
      use, intrinsic :: iso_c_binding
      implicit none
  ...
  interface
    function cublas_set_stream_c(cudaHandle, cudaStream) result(istat) &
             bind(C, name="mublasSetStreamFromC")
      use, intrinsic :: iso_c_binding
      implicit none
  ...
  interface
    function cublas_destroy_c(cudaHandle) result(istat) &
             bind(C, name="mublasDestroyFromC")
      use, intrinsic :: iso_c_binding
      implicit none
      integer(kind=C_intptr_T), value :: cudaHandle
      integer(kind=C_INT)      :: istat
  ...
  interface
    function cuda_setdevice_c(n) result(istat) &
             bind(C, name="musaSetDeviceFromC")
  ...
  interface
    function cuda_getdevicecount_c(n) result(istat) &
             bind(C, name="musaGetDeviceCountFromC")
      use, intrinsic :: iso_c_binding
      implicit none
  ...
  interface
    function cuda_devicesynchronize_c()result(istat) &
             bind(C,name="musaDeviceSynchronizeFromC")
  ...
  interface
    function cuda_memcpyDeviceToDevice_c() result(flag) &
             bind(C, name="musaMemcpyDeviceToDeviceFromC")
      use, intrinsic :: iso_c_binding
      implicit none
  ...
  interface
    function cuda_memcpyHostToDevice_c() result(flag) &
             bind(C, name="musaMemcpyHostToDeviceFromC")
      use, intrinsic :: iso_c_binding
      implicit none
      integer(kind=c_int) :: flag
    end function
  ...
  interface
    function cuda_memcpyDeviceToHost_c() result(flag) &
             bind(C, name="musaMemcpyDeviceToHostFromC")
      use, intrinsic :: iso_c_binding
      implicit none
      integer(kind=c_int) :: flag
    end function
  ...
  interface
    function cuda_hostRegisterDefault_c() result(flag) &
             bind(C, name="musaHostRegisterDefaultFromC")
      use, intrinsic :: iso_c_binding
      implicit none
      integer(kind=c_int) :: flag
    end function
  ...
  interface
    function cuda_hostRegisterPortable_c() result(flag) &
             bind(C, name="musaHostRegisterPortableFromC")
      use, intrinsic :: iso_c_binding
      implicit none
      integer(kind=c_int) :: flag
    end function
  ...
  interface
    function cuda_hostRegisterMapped_c() result(flag) &
             bind(C, name="musaHostRegisterMappedFromC")
      use, intrinsic :: iso_c_binding
      implicit none
      integer(kind=c_int) :: flag
    end function
  ...
  interface
    function cuda_memcpy_async_intptr_c(dst, src, size, dir, cudaStream) result(istat) &
             bind(C, name="musaMemcpyAsyncFromC")
      use, intrinsic :: iso_c_binding
      implicit none
      integer(kind=C_intptr_t), value              :: dst
      integer(kind=C_intptr_t), value              :: src
  ...
  interface
    function cuda_memcpy2d_intptr_c(dst, dpitch, src, spitch, width, height , dir) result(istat) &
             bind(C, name="musaMemcpy2dAsyncFromC")
      use, intrinsic :: iso_c_binding
      implicit none
      integer(kind=C_intptr_T), value                :: dst
  ...
  interface
    function cuda_host_register_c(a, size, flag) result(istat) &
             bind(C, name="musaHostRegisterFromC")
      use, intrinsic :: iso_c_binding
      implicit none
  ...
  interface
    function cuda_host_unregister_c(a) result(istat) &
             bind(C, name="musaHostUnregisterFromC")
      use, intrinsic :: iso_c_binding
      implicit none
      integer(kind=C_intptr_t), value              :: a
      integer(kind=C_INT)                          :: istat
  ...
  interface
    function cuda_malloc_host_intptr_c(a, width_height) result(istat) &
             bind(C, name="musaMallocHostFromC")
      use, intrinsic :: iso_c_binding
      implicit none
      integer(kind=c_intptr_t)                    :: a
      integer(kind=c_intptr_t), intent(in), value :: width_height
  ...
  interface
    function cuda_memset_async_c(a, val, size, cudaStream) result(istat) &
             bind(C, name="musaMemsetAsyncFromC")
      use, intrinsic :: iso_c_binding
      implicit none
      integer(kind=C_intptr_T), value            :: a
      integer(kind=C_INT), value                 :: val
  ...
  interface
    subroutine cublas_Dgemm_intptr_c(cublasHandle, cta, ctb, m, n, k, alpha, a, lda, b, ldb, beta, c, ldc) &
                              bind(C,name="mublasDgemm_elpa_wrapper")
      use, intrinsic :: iso_c_binding
      implicit none
  ...
  interface
    subroutine cublas_Sgemm_intptr_c(cublasHandle, cta, ctb, m, n, k, alpha, a, lda, b, ldb, beta, c, ldc) &
                              bind(C,name="mublasSgemm_elpa_wrapper")
      use, intrinsic :: iso_c_binding
      implicit none
      character(1,C_CHAR),value               :: cta, ctb
      integer(kind=C_INT),value               :: m,n,k
  ...
  interface
    subroutine cublas_Zgemm_intptr_c(cublasHandle, cta, ctb, m, n, k, alpha, a, lda, b, ldb, beta, c, ldc) &
                              bind(C,name="mublasZgemm_elpa_wrapper")
      use, intrinsic :: iso_c_binding
      implicit none
      character(1,C_CHAR),value               :: cta, ctb
      integer(kind=C_INT),value               :: m,n,k
  ...
  interface
    subroutine cublas_Cgemm_intptr_c(cublasHandle, cta, ctb, m, n, k, alpha, a, lda, b, ldb, beta, c, ldc) &
                              bind(C,name="mublasCgemm_elpa_wrapper")
      use, intrinsic :: iso_c_binding
      implicit none
      character(1,C_CHAR),value               :: cta, ctb
      integer(kind=C_INT),value               :: m,n,k
  ...
  interface
    subroutine cublas_Dcopy_intptr_c(cublasHandle, n, x, incx, y, incy) &
                              bind(C,name="mublasDcopy_elpa_wrapper")
      use, intrinsic :: iso_c_binding
      implicit none
      integer(kind=C_INT),value               :: n
  ...
  interface
    subroutine cublas_Scopy_intptr_c(cublasHandle, n, x, incx, y, incy) &
                              bind(C,name="mublasScopy_elpa_wrapper")
      use, intrinsic :: iso_c_binding
      implicit none
      integer(kind=C_INT),value               :: n
      integer(kind=C_INT), intent(in), value  :: incx,incy
  ...
  interface
    subroutine cublas_Zcopy_intptr_c(cublasHandle, n, x, incx, y, incy) &
                              bind(C,name="mublasZcopy_elpa_wrapper")
      use, intrinsic :: iso_c_binding
      implicit none
      integer(kind=C_INT),value               :: n
      integer(kind=C_INT), intent(in), value  :: incx,incy
  ...
  interface
    subroutine cublas_Ccopy_intptr_c(cublasHandle, n, x, incx, y, incy) &
                              bind(C,name="mublasCcopy_elpa_wrapper")
      use, intrinsic :: iso_c_binding
      implicit none
      integer(kind=C_INT),value               :: n
      integer(kind=C_INT), intent(in), value  :: incx,incy
  ...
  interface
    subroutine cublas_Dtrmm_intptr_c(cublasHandle, side, uplo, trans, diag, m, n, alpha, a, lda, b, ldb) &
                              bind(C,name="mublasDtrmm_elpa_wrapper")
      use, intrinsic :: iso_c_binding
      implicit none
  ...
  interface
    subroutine cublas_Strmm_intptr_c(cublasHandle, side, uplo, trans, diag, m, n, alpha, a, lda, b, ldb) &
                              bind(C,name="mublasStrmm_elpa_wrapper")
      use, intrinsic :: iso_c_binding
      implicit none
      character(1,c_char), value              :: side, uplo, trans, diag
      integer(kind=c_int), value              :: m, n
  ...
  interface
    subroutine cublas_Ztrmm_intptr_c(cublasHandle, side, uplo, trans, diag, m, n, alpha, a, lda, b, ldb) &
                              bind(C,name="mublasZtrmm_elpa_wrapper")
      use, intrinsic :: iso_c_binding
      implicit none
      character(1,c_char), value              :: side, uplo, trans, diag
      integer(kind=c_int), value              :: m, n
  ...
  interface
    subroutine cublas_Ctrmm_intptr_c(cublasHandle, side, uplo, trans, diag, m, n, alpha, a, lda, b, ldb) &
                              bind(C,name="mublasCtrmm_elpa_wrapper")
      use, intrinsic :: iso_c_binding
      implicit none
      character(1,c_char), value              :: side, uplo, trans, diag
      integer(kind=c_int), value              :: m, n
  ...
  interface
    subroutine cublas_Dtrmv_intptr_c(cublasHandle, uplo, trans, diag, n, a, lda, x, incx) &
                              bind(C,name="mublasDtrmv_elpa_wrapper")
      use, intrinsic :: iso_c_binding
      implicit none
  ...
  interface
    subroutine cublas_Strmv_intptr_c(cublasHandle, uplo, trans, diag, n, a, lda, x, incx) &
                              bind(C,name="mublasStrmv_elpa_wrapper")
      use, intrinsic :: iso_c_binding
      implicit none
      character(1,c_char), value               :: uplo, trans, diag
      integer(kind=c_int), value               :: n, lda, incx
  ...
  interface
    subroutine cublas_Ztrmv_intptr_c(cublasHandle, uplo, trans, diag, n, a, lda, x, incx) &
                              bind(C,name="mublasZtrmv_elpa_wrapper")
      use, intrinsic :: iso_c_binding
      implicit none
      character(1,c_char), value               :: uplo, trans, diag
      integer(kind=c_int), value               :: n, lda, incx
  ...
  interface
    subroutine cublas_Ctrmv_intptr_c(cublasHandle, uplo, trans, diag, n, a, lda, x, incx) &
                              bind(C,name="mublasCtrmv_elpa_wrapper")
      use, intrinsic :: iso_c_binding
      implicit none
      character(1,c_char), value               :: uplo, trans, diag
      integer(kind=c_int), value               :: n, lda, incx
  ...
  interface
    subroutine cublas_Dsyrk_intptr_c(cublasHandle, uplo, trans, n, k, alpha, a, lda, beta, c, ldc) &
                              bind(C,name="mublasDsyrk_elpa_wrapper")
      use, intrinsic :: iso_c_binding
      implicit none
  ...
  interface
    subroutine cublas_Ssyrk_intptr_c(cublasHandle, uplo, trans, n, k, alpha, a, lda, beta, c, ldc) &
                              bind(C,name="mublasSsyrk_elpa_wrapper")
      use, intrinsic :: iso_c_binding
      implicit none
      character(1,c_char), value              :: uplo, trans
      integer(kind=c_int), value              :: n, k, lda, ldc
  ...
  interface
    subroutine cublas_Zherk_intptr_c(cublasHandle, uplo, trans, n, k, alpha, a, lda, beta, c, ldc) &
                              bind(C,name="mublasZherk_elpa_wrapper")
      use, intrinsic :: iso_c_binding
      implicit none
      character(1,c_char), value              :: uplo, trans
      integer(kind=c_int), value              :: n, k, lda, ldc
  ...
  interface
    subroutine cublas_Cherk_intptr_c(cublasHandle, uplo, trans, n, k, alpha, a, lda, beta, c, ldc) &
                              bind(C,name="mublasCherk_elpa_wrapper")
      use, intrinsic :: iso_c_binding
      implicit none
      character(1,c_char), value              :: uplo, trans
      integer(kind=c_int), value              :: n, k, lda, ldc
  ...
  interface
    subroutine cublas_Dtrsm_intptr_c(cublasHandle, side, uplo, trans, diag, m, n, alpha, a, lda, b, ldb) &
                              bind(C,name="mublasDtrsm_elpa_wrapper")
      use, intrinsic :: iso_c_binding
      implicit none
      character(1,C_CHAR),value               :: side, uplo, trans, diag
      integer(kind=C_INT),value               :: m,n
  ...
  interface
    subroutine cublas_Strsm_intptr_c(cublasHandle, side, uplo, trans, diag, m, n, alpha, a, lda, b, ldb) &
                              bind(C,name="mublasStrsm_elpa_wrapper")
      use, intrinsic :: iso_c_binding
      implicit none
      character(1,C_CHAR),value               :: side, uplo, trans, diag
      integer(kind=C_INT),value               :: m,n
  ...
  interface
    subroutine cublas_Ztrsm_intptr_c(cublasHandle, side, uplo, trans, diag, m, n, alpha, a, lda, b, ldb) &
                              bind(C,name="mublasZtrsm_elpa_wrapper")
      use, intrinsic :: iso_c_binding
      implicit none
      character(1,C_CHAR),value               :: side, uplo, trans, diag
      integer(kind=C_INT),value               :: m,n
  ...
  interface
    subroutine cublas_Ctrsm_intptr_c(cublasHandle, side, uplo, trans, diag, m, n, alpha, a, lda, b, ldb) &
                              bind(C,name="mublasCtrsm_elpa_wrapper")
      use, intrinsic :: iso_c_binding
      implicit none
      character(1,C_CHAR),value               :: side, uplo, trans, diag
      integer(kind=C_INT),value               :: m,n
  ...
  interface
    subroutine cublas_Dgemv_c(cublasHandle, cta, m, n, alpha, a, lda, x, incx, beta, y, incy) &
                              bind(C,name="mublasDgemv_elpa_wrapper")
      use, intrinsic :: iso_c_binding
      implicit none
  ...
  interface
    subroutine cublas_Sgemv_c(cublasHandle, cta, m, n, alpha, a, lda, x, incx, beta, y, incy) &
                              bind(C,name="mublasSgemv_elpa_wrapper")
      use, intrinsic :: iso_c_binding
      implicit none
      character(1,C_CHAR),value               :: cta
      integer(kind=C_INT),value               :: m,n
  ...
  interface
    subroutine cublas_Zgemv_c(cublasHandle, cta, m, n, alpha, a, lda, x, incx, beta, y, incy) &
                              bind(C,name="mublasZgemv_elpa_wrapper")
      use, intrinsic :: iso_c_binding
      implicit none
      character(1,C_CHAR),value               :: cta
      integer(kind=C_INT),value               :: m,n
  ...
  interface
    subroutine cublas_Cgemv_c(cublasHandle, cta, m, n, alpha, a, lda, x, incx, beta, y, incy) &
                              bind(C,name="mublasCgemv_elpa_wrapper")
      use, intrinsic :: iso_c_binding
      implicit none
      character(1,C_CHAR),value               :: cta
      integer(kind=C_INT),value               :: m,n
  ...
  interface
    function cublas_pointerModeDevice_c() result(flag) &
               bind(C, name="mublasPointerModeDeviceFromC")
      use, intrinsic :: iso_c_binding
      implicit none
      integer(kind=c_int) :: flag
    end function
  ...
  interface
    function cublas_pointerModeHost_c() result(flag) &
               bind(C, name="mublasPointerModeHostFromC")
      use, intrinsic :: iso_c_binding
      implicit none
      integer(kind=c_int) :: flag
    end function
  ...
  interface
    subroutine cublas_getPointerMode_c(cublasHandle, mode) &
               bind(C, name="mublasGetPointerModeFromC")
      use, intrinsic :: iso_c_binding
      implicit none
      integer(kind=C_intptr_T), value   :: cublasHandle
  ...
  interface
    subroutine cublas_setPointerMode_c(cublasHandle, mode) &
               bind(C, name="mublasSetPointerModeFromC")
      use, intrinsic :: iso_c_binding
      implicit none
      integer(kind=C_intptr_T),value    :: cublasHandle
  ...
  interface
    subroutine cublas_Ddot_intptr_c(cublasHandle, length, x, incx, y, incy, result) &
               bind(C, name="mublasDdot_elpa_wrapper")
      use, intrinsic :: iso_c_binding
      implicit none
      integer(kind=C_intptr_T), value         :: cublasHandle
  ...
  interface
    subroutine cublas_Sdot_intptr_c(cublasHandle, length, x, incx, y, incy, result) &
               bind(C, name="mublasSdot_elpa_wrapper")
      use, intrinsic :: iso_c_binding
      implicit none
      integer(kind=C_intptr_T), value         :: cublasHandle
      integer(kind=C_INT), value              :: length, incx, incy
  ...
  interface
    subroutine cublas_Zdot_intptr_c(conj, cublasHandle, length, x, incx, y, incy, result) &
               bind(C, name="mublasZdot_elpa_wrapper")
      use, intrinsic :: iso_c_binding
      implicit none
  ...
  interface
    subroutine cublas_Cdot_intptr_c(conj, cublasHandle, length, x, incx, y, incy, result) &
               bind(C, name="mublasCdot_elpa_wrapper")
      use, intrinsic :: iso_c_binding
      implicit none
      character(1,C_CHAR),value               :: conj
      integer(kind=C_intptr_T), value         :: cublasHandle
  ...
  interface
    subroutine cublas_Dscal_intptr_c(cublasHandle, length, alpha, x, incx) &
               bind(C, name="mublasDscal_elpa_wrapper")
      use, intrinsic :: iso_c_binding
      implicit none
      integer(kind=C_intptr_T), value         :: cublasHandle
  ...
  interface
    subroutine cublas_Sscal_intptr_c(cublasHandle, length, alpha, x, incx) &
               bind(C, name="mublasSscal_elpa_wrapper")
      use, intrinsic :: iso_c_binding
      implicit none
      integer(kind=C_intptr_T), value         :: cublasHandle
      integer(kind=C_INT),value               :: length, incx
  ...
  interface
    subroutine cublas_Zscal_intptr_c(cublasHandle, length, alpha, x, incx) &
               bind(C, name="mublasZscal_elpa_wrapper")
      use, intrinsic :: iso_c_binding
      implicit none
      integer(kind=C_intptr_T), value         :: cublasHandle
      integer(kind=C_INT),value               :: length, incx
  ...
  interface
    subroutine cublas_Cscal_intptr_c(cublasHandle, length, alpha, x, incx) &
               bind(C, name="mublasCscal_elpa_wrapper")
      use, intrinsic :: iso_c_binding
      implicit none
      integer(kind=C_intptr_T), value         :: cublasHandle
      integer(kind=C_INT),value               :: length, incx
  ...
  interface
    subroutine cublas_Daxpy_intptr_c(cublasHandle, length, alpha, x, incx, y, incy) &
               bind(C, name="mublasDaxpy_elpa_wrapper")
      use, intrinsic :: iso_c_binding
      implicit none
      integer(kind=C_intptr_T), value         :: cublasHandle
      integer(kind=C_INT),value               :: length, incx, incy
  ...
  interface
    subroutine cublas_Saxpy_intptr_c(cublasHandle, length, alpha, x, incx, y, incy) &
               bind(C, name="mublasSaxpy_elpa_wrapper")
      use, intrinsic :: iso_c_binding
      implicit none
      integer(kind=C_intptr_T), value         :: cublasHandle
      integer(kind=C_INT),value               :: length, incx, incy
  ...
  interface
    subroutine cublas_Zaxpy_intptr_c(cublasHandle, length, alpha, x, incx, y, incy) &
               bind(C, name="mublasZaxpy_elpa_wrapper")
      use, intrinsic :: iso_c_binding
      implicit none
      integer(kind=C_intptr_T), value         :: cublasHandle
      integer(kind=C_INT),value               :: length, incx, incy
  ...
  interface
    subroutine cublas_Caxpy_intptr_c(cublasHandle, length, alpha, x, incx, y, incy) &
               bind(C, name="mublasCaxpy_elpa_wrapper")
      use, intrinsic :: iso_c_binding
      implicit none
      integer(kind=C_intptr_T), value         :: cublasHandle
      integer(kind=C_INT),value               :: length, incx, incy
