...
extern "C" void musa_check_device_info_FromC(int *info_dev, musaStream_t my_stream){
...
extern "C" void musa_accumulate_device_info_FromC(int *info_abs_dev, int *info_new_dev, musaStream_t my_stream){
...
template <typename T>
void cuda_copy_a_tmatc_FromC(T *a_dev, T *tmatc_dev, int *nblk_in, int *matrixRows_in, int *l_cols_in, int *l_colx_in, int *l_row1_in, musaStream_t my_stream){
  int nblk = *nblk_in;   
...
extern "C" void musa_copy_double_a_tmatc_FromC(double *a_dev, double *tmatc_dev, int *nblk_in, int *matrixRows_in, 
                                               int *l_cols_in, int *l_colx_in, int *l_row1_in, musaStream_t my_stream){
  cuda_copy_a_tmatc_FromC(a_dev, tmatc_dev, nblk_in, matrixRows_in, l_cols_in, l_colx_in, l_row1_in, my_stream);
}

extern "C" void musa_copy_float_a_tmatc_FromC(float *a_dev, float *tmatc_dev, int *nblk_in, int *matrixRows_in, 
                                              int *l_cols_in, int *l_colx_in, int *l_row1_in, musaStream_t my_stream){
  cuda_copy_a_tmatc_FromC(a_dev, tmatc_dev, nblk_in, matrixRows_in, l_cols_in, l_colx_in, l_row1_in, my_stream);
}

extern "C" void musa_copy_double_complex_a_tmatc_FromC(muDoubleComplex *a_dev, muDoubleComplex *tmatc_dev, int *nblk_in, int *matrixRows_in, 
                                                  int *l_cols_in, int *l_colx_in, int *l_row1_in, musaStream_t my_stream){
  cuda_copy_a_tmatc_FromC(a_dev, tmatc_dev, nblk_in, matrixRows_in, l_cols_in, l_colx_in, l_row1_in, my_stream);
}

extern "C" void musa_copy_float_complex_a_tmatc_FromC(muFloatComplex *a_dev, muFloatComplex *tmatc_dev, int *nblk_in, int *matrixRows_in, 
                                                 int *l_cols_in, int *l_colx_in, int *l_row1_in, musaStream_t my_stream){
  cuda_copy_a_tmatc_FromC(a_dev, tmatc_dev, nblk_in, matrixRows_in, l_cols_in, l_colx_in, l_row1_in, my_stream);
}
...
template <typename T>
void cuda_set_a_lower_to_zero(T *a_dev, int *na_in, int *matrixRows_in, int *my_pcol_in, int *np_cols_in, int *my_prow_in, int *np_rows_in, int *nblk_in, int *wantDebug_in, musaStream_t my_stream){
  int na = *na_in;
  int matrixRows = *matrixRows_in;
...
extern "C" void musa_set_a_lower_to_zero_FromC(char dataType, intptr_t a_dev, int *na_in, int *matrixRows_in, 
                                                      int *my_pcol_in, int *np_cols_in, int *my_prow_in, int *np_rows_in, 
                                                      int *nblk_in, int *wantDebug_in, musaStream_t my_stream){
  ...
  if (dataType=='Z') cuda_set_a_lower_to_zero<muDoubleComplex>((muDoubleComplex *) a_dev, na_in, matrixRows_in, my_pcol_in, np_cols_in, my_prow_in, np_rows_in, nblk_in, wantDebug_in, my_stream);
  if (dataType=='C') cuda_set_a_lower_to_zero<muFloatComplex> ((muFloatComplex *) a_dev, na_in, matrixRows_in, my_pcol_in, np_cols_in, my_prow_in, np_rows_in, nblk_in, wantDebug_in, my_stream);
}