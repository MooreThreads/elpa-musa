...
extern "C" void launch_compute_hh_trafo_c_cuda_kernel_real_double(double *q, const double *hh, const double *hh_tau, const int nev, const int nb, const int ldq, const int ncols, musaStream_t my_stream)
{
    musaError_t err;
...
extern "C" void launch_compute_hh_trafo_c_cuda_kernel_real_single(float *q, const float *hh, const float *hh_tau, const int nev, const int nb, const int ldq, const int ncols, musaStream_t my_stream)
